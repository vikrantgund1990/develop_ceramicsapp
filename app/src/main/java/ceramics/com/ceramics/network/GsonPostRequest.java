...
public class GsonPostRequest<T> extends Request<T> {
	 ...
	 */
	public GsonPostRequest(String url, Type clazz, JSONObject params, Listener<T> listener, ErrorListener errorListener, final Activity activity) {
	 ...
	 * @param errorListener
	 */
	public GsonPostRequest(int method, String url, Class<T> clazz, JSONObject params, Listener<T> listener, ErrorListener errorListener, Activity activity) {
	 ...
	 *            Map of request headers
	 */
	public GsonPostRequest(String url, Type clazz, JSONObject params, Listener<T> listener, ErrorListener errorListener) {
		super(Method.POST, url, errorListener);
		this.clazz = clazz;
		this.params=params;
		this.listener = listener;
